...
import { setErrorMsg, setSuccessMsg } from "./Redux/userRedux";
    ...
    <Router basename="/">
      ...
      <Routes>
        <Route
          exact
          path="/"
          element={!user ? <Landing /> : <Navigate to="/posts" />}
        />
        <Route
          exact
          path="/auth"
        ...
        <Route
          exact
          path="/People"
          element={<Peoples isConnected={isConnected} />}
        />
        <Route
          exact
          path="/message/:id"
          element={<Messages isConnected={isConnected} />}
        />
      </Routes>
    </Router>
  );
