...
import { handleChange, handleFileUpload, handleSubmit, initialText } from './handlers';
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <button type='button' 
            ...
            onClick={(e) =>  handleSubmit(e, selectedFiles, cat, editId, fullname,
            inputText, dispatch, setInputText, setSelectedFiles, navigate)}
          >
            Post
          </button>
        </div>
        ...
        {categoryActive 
        && <Category setCategoryActive={setCategoryActive} />}
      </div>
      {isFetching && <Spinner />}
    </div>
  )
