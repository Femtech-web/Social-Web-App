...
import findBySearch from '../application/use_case/post/findBySearch';
...
import likePostById from '../application/use_case/post/likePostById';
import commentById from '../application/use_case/post/commentById';
...
export default function postController(
  ...
  const deletePostById = (req, res, next) => {
    deletePost(req.params.id, dbRepository)
      .then(() => res.json({message: 'post sucessfully deleted!'}))
      .catch((error) => next(error));
  };
